# SFTS
R scripts and data for the manuscript titled "Spatio-temporal data do not bypass the space-time equivalence assumption in species distribution models".
